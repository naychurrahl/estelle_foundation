        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-start gap-3">
                ...
                <a
                  href={`https://${organizationInfo.contact.website}`}
                  className="hover:text-orange-500 transition-colors"
                >
                  {organizationInfo.contact.website}
                </a>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href="#get-involved" className="hover:text-orange-500 transition-colors">
                  Get Involved
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Stay connected with our work and impact</p>
